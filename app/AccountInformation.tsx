...
export default function AccountInformation() {
  ...
  const pickAvatar = async () => {
    ...
    if (!permission.granted) {
      Alert.alert('Permission Required', 'Please allow access to your photo library to choose a profile photo.');
      return;
    }
    ...
    setAvatarFile({
      uri: asset.uri,
      name: asset.fileName || `profile-photo.${mimeType.split('/')[1] || 'jpg'}`,
      mimeType,
    });
          ...
          <View style={s.avatarCard}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={s.avatarSub}>
                {avatarFile ? 'New photo selected. Save to upload it.' : 'Choose the photo shown on your profile.'}
              </Text>
            </View>
            <TouchableOpacity style={s.avatarBtn} onPress={pickAvatar} activeOpacity={0.8}>
...
function getStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    avatarTitle: { fontSize: 14, fontWeight: '700', color: colors.text, marginBottom: 3 },
