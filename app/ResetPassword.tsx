...
export default function ResetPasswordScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const message = err.response?.data?.error || 'Failed to reset your password. Please try again.';
        ...
        >
          ...
          {invalidToken ? (
            ...
            <View style={styles.centerWrap}>
              ...
              <TouchableOpacity style={styles.primaryBtn} onPress={() => router.replace('/ForgotPassword')}>
            ...
            <View style={styles.centerWrap}>
              ...
              <TouchableOpacity
                ...
                onPress={() => router.replace(`/house_seekers_login_signup?tab=login`)}
              >
              ...
              <View style={styles.fieldGroup}>
                ...
                <View style={styles.inputWrap}>
                  ...
                  <TouchableOpacity onPress={() => setShowConfirm(v => !v)}>
                    <Feather name={showConfirm ? 'eye-off' : 'eye'} size={15} color="#9CA3AF" />
                  </TouchableOpacity>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  strengthHint: {
    ...
    backgroundColor: '#F9FAFB', borderRadius: 12, padding: 12, marginBottom: 20,
  },
  ...
  centerTitle: { fontSize: 21, fontWeight: '800', color: '#111827', marginBottom: 8, letterSpacing: -0.3 },
  centerDesc: { fontSize: 14, color: '#6B7280', textAlign: 'center', lineHeight: 22, marginBottom: 24, maxWidth: 320 },
});
