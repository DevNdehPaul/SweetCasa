...
const TOS_SECTION_KEYS = [
  {
    num: '1',
    titleKey: 'terms.seeker.tos.s1.title',
    content: [
      { boldKey: 'terms.seeker.tos.s1.bold1', textKey: 'terms.seeker.tos.s1.text1' },
      { boldKey: 'terms.seeker.tos.s1.bold2', textKey: 'terms.seeker.tos.s1.text2' },
    ],
  },
  {
    num: '2',
    titleKey: 'terms.seeker.tos.s2.title',
    content: [{ boldKey: '', textKey: 'terms.seeker.tos.s2.body' }],
  },
  {
    num: '3',
    titleKey: 'terms.seeker.tos.s3.title',
    content: [{ boldKey: '', textKey: 'terms.seeker.tos.s3.body' }],
  },
  {
    num: '4',
    titleKey: 'terms.seeker.tos.s4.title',
    content: [{ boldKey: '', textKey: 'terms.seeker.tos.s4.body' }],
  },
  {
    num: '5',
    titleKey: 'terms.seeker.tos.s5.title',
    content: [{ boldKey: '', textKey: 'terms.seeker.tos.s5.body' }],
  },
];

const PRIVACY_SECTION_KEYS = [
  { num: '1', titleKey: 'terms.seeker.privacy.s1.title', bodyKey: 'terms.seeker.privacy.s1.body' },
  { num: '2', titleKey: 'terms.seeker.privacy.s2.title', bodyKey: 'terms.seeker.privacy.s2.body' },
  { num: '3', titleKey: 'terms.seeker.privacy.s3.title', bodyKey: 'terms.seeker.privacy.s3.body' },
  { num: '4', titleKey: 'terms.seeker.privacy.s4.title', bodyKey: 'terms.seeker.privacy.s4.body' },
];
    ...
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView ref={scrollRef} contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.hero}>
          ...
          <Text style={s.heroSub}>{t('terms.seeker.heroSub')}</Text>
          <Text style={s.heroDate}>{t('terms.lastUpdated')}</Text>
          <Text style={s.heroDesc}>{t('terms.seeker.heroDesc')}</Text>
        </View>
