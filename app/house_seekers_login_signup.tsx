...
/**
 * IMPORTANT:
 * The ref passed to this helper must point directly to a native host
 * component such as TextInput.
 *
 * Previously this function received a ref attached to <View>, which can
 * produce:
 *
 * "ref.measureLayout must be called with a ref to a native component."
 *
 * TextInput is a native host component, so measureLayout is safe here.
 */
function scrollFieldIntoView(
  ...
  setTimeout(() => {
    ...
    field.measureLayout(
      ...
      () => {
        // Measurement can fail while the keyboard/layout is still
        // transitioning. The keyboard listener below retries it.
      },
    );
  }, 100);
}
...
/**
 * Handles the Android timing issue where TextInput.onFocus fires before
...
function useSocialAuth(role: 'BUYER') {
  ...
  const [, googleResponse, promptGoogleAsync] =
  ...
  const handleGoogleAuth = useCallback(async () => {
    if (
      ...
      Alert.alert(
        'Not Configured',
        'Google Sign-In is not set up yet. Please try again later.',
      );
      return;
    }
    ...
    <View style={s.fieldGroup}>
      ...
      <View style={s.idInfoCard}>
        ...
        <Text style={s.idInfoText}>
          Your national ID is used solely for
          identity verification and is stored
          securely.
        </Text>
      </View>
  ...
  return (
    ...
    >
      <View style={s.authHero}>
        ...
        <Text style={s.authHeroTitle}>
          Welcome Back
        </Text>

        <Text style={s.authHeroDesc}>
          Sign in to browse verified
...
function SignupTab({
  ...
  const [nationalIdFile, setNationalIdFile] =
    useState<NationalIdFile>(null);
  ...
  // IMPORTANT:
  // These refs now point directly to TextInput.
  // Previously they were attached to <View>, causing measureLayout warning.
  ...
  const passwordKeyboard =
    useScrollFieldOnKeyboard(
      scrollRef,
      passwordFieldRef,
      140,
    );

  const confirmPasswordKeyboard =
    useScrollFieldOnKeyboard(
      scrollRef,
  ...
  const clearSensitiveRegistrationState =
    useCallback(() => {
      setForm(EMPTY_FORM);
  ...
  const handleSignup = async () => {
    ...
    if (
      ...
      Alert.alert(
        'Missing Fields',
        'Please fill in your full name, email, and password.',
      );
    ...
    if (!nationalIdFile) {
      Alert.alert(
        'Missing Fields',
        'Please upload your national ID to verify your identity.',
      );
    ...
    >
      ...
      >
        ...
        <View style={s.fieldGroup}>
          ...
          <TouchableOpacity
            style={s.emailHelpLink}
            onPress={
              openEmailSignupOptions
            }
            activeOpacity={0.8}
          >
        ...
        <View style={s.fieldGroup}>
          ...
          <View style={s.inputWrap}>
            ...
            <TextInput
              ...
              onFocus={
                passwordKeyboard.handleFocus
              }
              onBlur={
                passwordKeyboard.handleBlur
              }
            />
        ...
        <View style={s.fieldGroup}>
          ...
          <View style={s.inputWrap}>
            ...
            <TextInput
              ...
              onFocus={
                confirmPasswordKeyboard.handleFocus
              }
              onBlur={
                confirmPasswordKeyboard.handleBlur
              }
            />
    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={s.formHeader}>
          ...
          <Text
            style={s.formHeaderSub}
          >
            House Seekers Portal
          </Text>
        </View>
