...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: '#C8C0F0' },
  container: { flex: 1, justifyContent: 'space-between', paddingBottom: 60 },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  iconWrap: { alignItems: 'center', justifyContent: 'center' },
  brandName: {
    fontSize: 52, color: '#5B4FA8', fontStyle: 'italic', fontWeight: '700',
    letterSpacing: 1, textShadowColor: 'rgba(91, 79, 168, 0.2)',
    textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 4,
  },
  tagline: { fontSize: 16, color: '#6B5FC0', fontWeight: '400', letterSpacing: 0.5 },
  bottomArea: { alignItems: 'center' },
  progressTrack: {
    width: width * 0.45, height: 3,
    backgroundColor: 'rgba(255,255,255,0.3)', borderRadius: 4, overflow: 'hidden',
  },
  progressFill: { height: '100%', backgroundColor: '#5B4FA8', borderRadius: 4 },
});