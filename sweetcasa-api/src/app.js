...
const viewingRoutes = require('./routes/viewing.routes') // ← NEW (favourites / saved listings)
...
app.use('/favourites', express.json(), favouriteRoutes)
app.use('/viewing-requests', viewingRoutes) // ← NEW (favourites)
